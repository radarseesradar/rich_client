 ...
 */
package smartClient.classServer;
 ...
 * server.
 */
public class ClassFileServer extends smartClient.classServer.ClassServer {
    
    private String classpath;
    
    private final static int DefaultServerPort = 2001;
