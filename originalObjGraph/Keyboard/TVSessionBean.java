 ...
 * generated by emit_jbo(Dec 21 2000) on 04/19/01 at 09:56:08 AM
 */
package Keyboard;
	...
	// end_safe_additionalInterfaces
{
	...
	// begin_safe_storeAll
          ...
          Visitable objectsToStore = (Visitable) (new Serializer()).deserialize( objectGraph );
	...
	// begin_safe_retrieveAll
          ...
          return (new Serializer()).serialize( transientGraph );
	...
	// begin_safe_retrieveAllFromStub
          ...
          Stub stubObj = (Stub) (new Serializer()).deserialize( stub );
	...
	// begin_safe_execute
          ...
          aCommand = (CommandInterface) (new Serializer()).deserialize( command );
          aCommand.execute();
	...
	// begin_safe_allocateIDs_javadoc_comment
	// end_safe_allocateIDs_javadoc_comment
	public long allocateIDs(int quantity)
	// begin_safe_allocateIDs_throws
	// end_safe_allocateIDs_throws
