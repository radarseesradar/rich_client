...
// end_safe_additional_interfaces
{
	...
	public Keyboard.TVSessionBeanObject create() throws javax.ejb.CreateException, java.rmi.RemoteException
	{
		...
		try {
			...
			Keyboard.TVSessionBean bo = new Keyboard.TVSessionBean();
			EJBSessionContext _ctx = _service.newSessionContext(_deploymentPkg);
			bo.setSessionContext((javax.ejb.SessionContext)_ctx);
			bo.ejbCreate();
			return (Keyboard.TVSessionBeanObject)_service.registerSessionBean(bo, _jndiName, _ctx);
		}
		catch (Throwable _t) {
