...
public class AccessMethodNameGenerator
{
  ...
  public void setSpecialPluralsUsing( String filename )
  {
    ...
    catch ( IOException ioe )
    {
            IdeMessageManagerAccess.printMessage
                (IdeMessageType.INFORMATION, "Error in Reading properties File :" + ioe);
    }
    finally
    {
      try
  ...
  public String getSingular( String _aRoleName )
  {
    ...
    {
    	this.setSpecialPluralsUsing( (new File(IdeProjectManagerAccess.getProjectManager().getActiveProject().getFileName())).getParent() + "\\specialPlurals.properties"  );
    }
